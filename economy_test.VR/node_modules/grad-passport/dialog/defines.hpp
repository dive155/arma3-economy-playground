...
// editable
#define GRAD_PASSPORT_DEFAULT_W                 (0.8000 * X_SCALE)
#define GRAD_PASSPORT_DEFAULT_H                 (0.4000 * Y_SCALE)
#define GRAD_PASSPORT_LINE_H                    (0.0500 * Y_SCALE)
#define GRAD_PASSPORT_LINESPACE_Y               (0.0350 * Y_SCALE)
#define GRAD_PASSPORT_PADDING_X                 (0.2 * X_SCALE)
#define GRAD_PASSPORT_PADDING_Y                 (0.12 * Y_SCALE)
...
#define GRAD_PASSPORT_DEFAULT_RIGHTCOLUMN_X     (GRAD_PASSPORT_DEFAULT_X + GRAD_PASSPORT_DEFAULT_W - 0.38 * X_SCALE)
